...
in let urls = concatMap ({ version, bindists, ... }: map (bindist: "https://haskell.org/ghc/dist/${version}/ghc-${version}-powerpc64le-${bindist}.tar.xz") bindists) versions;
